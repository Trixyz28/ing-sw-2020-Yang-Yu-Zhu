    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "it.polimi.ingsw");
                servletContext.setInitParameter("tapestry.development-modules", "it.polimi.ingsw.services.DevelopmentModule");
